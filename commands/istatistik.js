...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .addFields({ name: 'Bot Sahibi', value: `RayN#3333`, inline: false})
    ...
    .addFields({ name: '• Bot Kuruluş', value: `05.09.2020`, inline: true})
    .addFields({ name: '• Komut Sayısı', value: `28`, inline: true})
